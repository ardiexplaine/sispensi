...
<h3 class="heading">RANPERDA INDUK</h3>
    ...
    <div class="row formSep">
        <div class="col-sm-10 col-md-10">
            <div id="divtxtDaerah" class="form-group">
                <label for="txtDaerah" class="col-lg-2 control-label">Daerah</label>
                <div class="col-lg-4">
                    <input type="text" class="input-sm form-control" id="txtDaerah" readonly="readonly">
                </div>
            </div>
        </div>	
    </div>
    ...
    <div class="row formSep">
        <div class="col-sm-10 col-md-10">
            <div id="divtxtUsername" class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" class="input-sm form-control" id="txtUsername" readonly="readonly">
                </div>
            </div>
        </div>	
    </div>
